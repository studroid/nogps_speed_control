...
"""
© Copyright 2016, Team Godrone at Yonsei University.
nogps_speed_control.py
...
import argparse  
parser = argparse.ArgumentParser(description='Control Copter and send commands in NO_GUIDED mode ')
...
# Goal distance for each coordination in meter
#GOAL_X = 3;
#GOAL_Y = 0;
...
print("!!!!!!!!!!! MOVING START !!!!!!!!!")
#while totalX < GOAL_X or totalY < GOAL_Y:
while totalDrivingTime < GOAL_DRIVING_TIME:
    if currentVelocityX < GOAL_X_VELOCITY:
        roll += 0.2
    else:
        roll -= 0.2
    ...
    currentVelocityY = distance['y']/execTime
...
#set_attitude(pitch_angle = -1*FORWARD_ANGLE, duration = 0.2)
